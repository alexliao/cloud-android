...
public abstract class CloudAlarmService extends IntentService {
	...
	public void onCreate(){
		...
		//mFeedHelper.open();
		Log.d("grapps", "Cloud CloudAlarmService - create service");
	}

	@Override
	public void onDestroy(){
		Log.d("grapps", "Cloud CloudAlarmService - destroy service");
		//mFeedHelper.close();
    	super.onDestroy();
	}
...
//	}
    ...
    public void setNextRun(Class<?> cls){
    	Log.d("Cloud", "Cloud "+cls.getName()+" - setNextRun after: " + getNextInterval());
    ...
    static public void cancelNextRun(Context context, Class<?> cls){
    	...
    	Log.d("Cloud", "Cloud "+cls.getName()+" - Next run canceled");
    }
    
	public int getNextInterval(){
		String str = Utils.getUserPrefString(this, this.getClass().getName()+"nextInterval");
		int ret;
		if(str == null) ret = 1;
